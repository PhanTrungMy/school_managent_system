            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form method="post" action="{{ route('marks.grade.update',$editData->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="start_points" class="form-control" required="" value="{{$editData->start_points}}"  >
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="end_points" class="form-control" required="" value="{{$editData->end_points}}"   >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
