                    ...
                    <div class="col-12">
                        ...
                        <div class="box bb-3 border-warning">
                            <div class="box-header">
                                <h4 class="box-title">Report <strong>MarksSheet PDF</strong></h4>
                            </div>
<div class="box-body" style="border: solid 1px; pading:10px;">
<div class="row">
    <div style="float: right" class="col-md-2 text-center">
        <img src="{{url('upload/easyschool.png')}}" style="width: 120px;height:100px" alt=""> 
    </div>
    ...
    <div class="col-md-12">
        <hr style="border:solid 1px; width:100%;color: #ddd;magin-bottom:0px;">
    ...
    <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="8" cellspacing="2">
      ...
      <tbody>
        ...
        <tr>
            ...
            <td>{{number_format((float)$mark->grad_point,2)}}-{{($mark->grad_point == 5)?(number_format((float)$mark_grade_point,2)):(number_format((float)$mark_grade_point+1,2)-(float)0.01)}}</td>
        </tr>
      </tbody>
    </table>
</div>
