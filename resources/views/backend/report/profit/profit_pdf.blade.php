...
<table id="customers">s
    <tr>
        <td><h2>
                <?php $image_path = '/upload/trungmy.jpg'; ?>
        ...
        <td><h2>Easy School ERP</h2>
            ...
            <p><b>Account Monthly / Yearly Profit Salary</b></p>

        </td>
    </tr>
</table>
@php
     $student_fee = App\Models\AccountStudent::whereBetween('date', [$start_date, $end_date])->sum('amount');
...
<table id="customers">
    ...
    <td colspan="2" style="text-align: center">
        <h4>Reporting Date:{{ date('d M Y',strotime($start_date))}}-{{ date('d M Y',strotime($end_date))}}</h4>
    </td>
    </tr>
    <tr>
