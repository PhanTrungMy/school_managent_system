                    ...
                    <div class="col-12">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <a href="{{route('assign.subject.add')}}" style="float: right" class="btn btn-rounded btn-success mb-5">Add Assign Subject Amount</a>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <h4> <strong>Assign Subject : </strong>{{$detailsData['0']['school_subject']['name']}}</h4>
